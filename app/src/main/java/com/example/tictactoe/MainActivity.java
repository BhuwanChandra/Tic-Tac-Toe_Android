...
public class MainActivity extends AppCompatActivity {
    ...
    public void won(ImageView img) {
        final Bitmap map = ((BitmapDrawable) img.getDrawable()).getBitmap();
        final Bitmap xmyLogo = ((BitmapDrawable) getResources().getDrawable(R.drawable.ximg)).getBitmap();
        final Bitmap omyLogo = ((BitmapDrawable) getResources().getDrawable(R.drawable.oimg)).getBitmap();
